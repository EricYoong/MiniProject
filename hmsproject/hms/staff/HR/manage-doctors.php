...
if (isset($_GET['del'])) {
    mysqli_query($con, "delete from stafftb where id = '" . $_GET['id'] . "'");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">HR | Manage Staff</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>HR</span>
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<?php echo htmlentities($_SESSION['msg'] = ""); ?></p>
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql = mysqli_query($con, "select * from stafftb");
$cnt = 1;
while ($row = mysqli_fetch_array($sql)) {
    ?>
											...
											<tr>
												...
												<td><?php echo $row['S_LEVEL']; ?></td>
												<td><?php echo $row['S_WORKHOUR']; ?>
												</td>
                                                <td><?php echo $row['S_SALARY']; ?></td>
												<td><?php echo $row['S_DOB']; ?>
												</td>
                                                <td><?php echo $row['S_specilization']; ?></td>
