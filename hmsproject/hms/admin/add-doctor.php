...
<div class="form-group">
					...
					<input type="email" name="docemail" class="form-control"  placeholder="Enter Doctor Email ">
														</div>
					...
					<input type="password" name="npass" class="form-control"  placeholder="At least 6 character" required="required" pattern=".{6,}">
														</div>
...
<div class="form-group">
									...
									<input type="password" name="cfpass" class="form-control"  placeholder="At least 6 character " required="required"pattern=".{6,}">
														</div>
