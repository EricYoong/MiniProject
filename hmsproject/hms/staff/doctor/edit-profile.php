...
if (isset($_POST['submit'])) {
    ...
    $sql               = mysqli_query($con, "Update stafftb set specilization='$docspecialization',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno' where id='" . $_SESSION['id'] . "'");
    if ($sql) {
